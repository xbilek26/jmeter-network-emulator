...
public class NetworkEmulatorConverter {
    ...
    public static NetworkParameters convertToNetworkParameters(CollectionProperty propertyParameters) {
        ...
        networkParameters.setLossValue(NumberUtils.toInt(propertyParameters.get(7).getStringValue(), -1));
        networkParameters.setLossCorrelation(NumberUtils.toInt(propertyParameters.get(8).getStringValue(), -1));
        networkParameters.setRate(NumberUtils.toInt(propertyParameters.get(9).getStringValue(), -1));
        networkParameters.setReorderingValue(NumberUtils.toInt(propertyParameters.get(10).getStringValue(), -1));
        networkParameters.setReorderingCorrelation(NumberUtils.toInt(propertyParameters.get(11).getStringValue(), -1));
        networkParameters.setDuplicationValue(NumberUtils.toInt(propertyParameters.get(12).getStringValue(), -1));
        networkParameters.setDuplicationCorrelation(NumberUtils.toInt(propertyParameters.get(13).getStringValue(), -1));
        networkParameters.setCorruption(NumberUtils.toInt(propertyParameters.get(14).getStringValue(), -1));
