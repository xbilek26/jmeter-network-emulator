package cz.vutbr.networkemulator.model.utils;
...
public final class NetworkEmulatorConstants {
    ...
    public static final String EMULATOR_NAME = "Network Emulator";
    ...
    public static final String TITLE_CONFIG = "Configuration Panel";
    ...
    public static final Object MSG_ENTER_VALID_IP_ADDRESS = "Enter a valid IPv4 or IPv6 Address.";
