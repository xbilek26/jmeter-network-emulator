...
public class NetworkEmulatorGui extends AbstractJMeterGuiComponent {
    ...
    private JPanel createSettingsPanel() {
        ...
        settingsPanel.setBorder(BorderFactory.createTitledBorder(Messages.get("title_network_settings")));
    ...
    private JPanel createControlPanel() {
        ...
        controlPanel.setBorder(BorderFactory.createTitledBorder(Messages.get("title_controls")));
        ...
        btnStart = new JButton(Messages.get("button_start"));
        btnStart.setIcon(startImage);
        btnStart.setFocusable(false);
        btnStart.setEnabled(true);
        btnStart.addActionListener(this::toggleEmulator);

        btnStop = new JButton(Messages.get("button_stop"));
        ...
        emulatorState = new JLabel(Messages.get("msg_emulation_stopped"), JLabel.CENTER);
    ...
    private void toggleEmulator(ActionEvent evt) {
        ...
        if (source == btnStart) {
            ...
            currentSettings.setText(controller.getNetworkConfiguration());
            emulatorState.setText(Messages.get("msg_emulation_running"));
            ...
            currentSettings.setText(controller.getNetworkConfiguration());
            emulatorState.setText(Messages.get("msg_emulation_stopped"));
        }
    }
    ...
    public String getLabelResource() {
        return Messages.get("network_emulator_label_resource");
    }

    @Override
    public String getStaticLabel() {
        return Messages.get("network_emulator_static_label");
    }
    ...
    public void configure(TestElement element) {
        ...
        emulatorState.setText(running
                ? Messages.get("msg_emulation_running")
                : Messages.get("msg_emulation_stopped"));
