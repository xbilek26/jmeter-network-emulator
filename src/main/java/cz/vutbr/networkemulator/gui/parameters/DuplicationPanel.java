...
public class DuplicationPanel extends JPanel {
    ...
    public DuplicationPanel() {
        ...
        setBorder(BorderFactory.createTitledBorder(NetworkEmulator.getString("title_duplication")));

        valueField = new JTextField(8);
        correlationField = new JTextField(8);

        JLabel valueLabel = new JLabel(NetworkEmulator.getString("label_duplication_value"));
        valueLabel.setLabelFor(valueField);
        JLabel correlationLabel = new JLabel(NetworkEmulator.getString("label_duplication_correlation"));
